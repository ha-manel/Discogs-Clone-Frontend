...
# 📖 Discogs Clone <a name="about-project"></a>
...
- [Live Demo Link](https://discogs-clone-frontend.vercel.app/)
...
```sh
  cd my-folder
  git clone git@github.com:ha-manel/Discogs-Clone-Frontend.git
```
